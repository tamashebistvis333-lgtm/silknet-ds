...
public struct SilknetColorPalette {
    ...
    public let silkfest100: Color = Color(uiColor: UIColor(red: 1, green: 0.89, blue: 0.8, alpha: 1))
    public let silkfest200: Color = Color(uiColor: UIColor(red: 1, green: 0.78, blue: 0.6, alpha: 1))
    public let silkfest300: Color = Color(uiColor: UIColor(red: 1, green: 0.671, blue: 0.4, alpha: 1))
    public let silkfest400: Color = Color(uiColor: UIColor(red: 1, green: 0.561, blue: 0.2, alpha: 1))
    public let silkfest500: Color = Color(uiColor: UIColor(red: 1, green: 0.451, blue: 0, alpha: 1))
    public let silkfest600: Color = Color(uiColor: UIColor(red: 0.8, green: 0.361, blue: 0, alpha: 1))
    public let silkfest700: Color = Color(uiColor: UIColor(red: 0.6, green: 0.271, blue: 0, alpha: 1))
    public let silkfest800: Color = Color(uiColor: UIColor(red: 0.4, green: 0.18, blue: 0, alpha: 1))
    public let silkfest900: Color = Color(uiColor: UIColor(red: 0.302, green: 0.137, blue: 0, alpha: 1))
    public let silkfest950: Color = Color(uiColor: UIColor(red: 0.2, green: 0.09, blue: 0, alpha: 1))
    public let silkfest4: Color = Color(uiColor: UIColor(red: 1, green: 0.451, blue: 0, alpha: 0.039))
    public let silkfest8: Color = Color(uiColor: UIColor(red: 1, green: 0.451, blue: 0, alpha: 0.078))
    public let silkfest16: Color = Color(uiColor: UIColor(red: 1, green: 0.451, blue: 0, alpha: 0.161))
    public let silkfest24: Color = Color(uiColor: UIColor(red: 1, green: 0.451, blue: 0, alpha: 0.239))
    public let silkfest32: Color = Color(uiColor: UIColor(red: 1, green: 0.451, blue: 0, alpha: 0.322))
    public let silkfest40: Color = Color(uiColor: UIColor(red: 1, green: 0.451, blue: 0, alpha: 0.4))
    public let silkfest48: Color = Color(uiColor: UIColor(red: 1, green: 0.451, blue: 0, alpha: 0.478))
